...
/**
 * Template Name: Free-Social-Network - Activity Directory
 *
 * @package BuddyPress
 * @subpackage Theme
 */echo "hello from fsn";
...
// include wp-load.php to load wordpress env and run wordpress and buddypress functions, when loaded through Angular route the wordpress env isnt loaded that way.
 ...
 ?>
	...
	<div id="content" class="text-center">
		<div class="padder">
			...
			<div class="item-list-tabs activity-type-tabs row" role="navigation">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<ul class="list-inline float_lists_left">
						<?php do_action( 'bp_before_activity_type_tab_all' ); ?>
<!--  All members tab is disabled by commenting
...
-->
						<?php if ( is_user_logged_in() ) : ?>
							...
							<?php if ( bp_is_active( 'friends' ) ) : ?>
								...
								<?php if ( bp_get_total_friend_count( bp_loggedin_user_id() ) ) : ?>
									...
									<li id="activity-friends" class="selected"><a href="<?php echo bp_loggedin_user_domain() . bp_get_activity_slug() . '/' . bp_get_friends_slug() . '/'; ?>" title="<?php esc_attr_e( 'The activity of my friends only.', 'buddypress' ); ?>"><?php printf( __( 'My Friends <span>%s</span>', 'buddypress' ), bp_get_total_friend_count( bp_loggedin_user_id() ) ); ?></a></li>
			...
			<div class="item-list-tabs no-ajax row" id="subnav" role="navigation">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<ul class="list-inline float_lists_left">
			...
			<div class="activity row" role="main">
				<div class="col-md-12 col-sm-12 col-xs-12">
