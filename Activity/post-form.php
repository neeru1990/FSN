			...
			<div id="whats-new-content">
				<div class="form-group">
					<div id="whats-new-textarea">
						<textarea name="whats-new" id="whats-new" class="bp-suggestions form-control" cols="50" rows="2"><?php if ( isset( $_GET['r'] ) ) : ?>@<?php echo esc_textarea( $_GET['r'] ); ?> <?php endif; ?></textarea>
					</div>
				</div>
